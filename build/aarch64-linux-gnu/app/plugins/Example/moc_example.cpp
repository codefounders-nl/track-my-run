...
void Example::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Example *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Example::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Example.data,
    qt_meta_data_Example,
    qt_static_metacall,
    nullptr,
    nullptr
} };
